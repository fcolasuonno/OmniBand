package com.omniband.data.repository
...
class HealthRepository @Inject constructor(
    ...
    suspend fun startSleepSession(address: String): Long =
        sleepDao.insertSession(SleepSessionEntity(deviceAddress = address, startTime = System.currentTimeMillis()))
    ...
    suspend fun addSleepStage(sessionId: Long, stage: String) {
        sleepDao.insertStage(SleepStageEntity(sessionId = sessionId, stage = stage, timestamp = System.currentTimeMillis()))
    }
    ...
    suspend fun saveBattery(address: String, percent: Int, charging: Boolean) {
        batteryDao.insert(BatteryEntity(deviceAddress = address, percent = percent, charging = charging))
    }
}
